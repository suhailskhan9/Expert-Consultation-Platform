...
<div className="bg-blue-100 h-screen flex flex-col justify-center items-center">
  <h2 className="text-4xl  mb-4">Welcome to <span className='font-mono font-bold'>XpertConsult</span></h2>
  <p className="text-lg text-gray-800 mb-8">Choose your role to get started:</p>
</div>
